...
|------|-------------|------|---------------------|
| `sap_fuel.csv` | `sap` | 50 | Alternate column names (`Menge`, `Einheit`, `Werk`); dates `DD.MM.YYYY`, `YYYY-MM-DD`, `MM/DD/YYYY`; units L, gal, kg, m3, liters; unknown unit `STONE`; plant `INVALID_X` |
